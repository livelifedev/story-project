...
const Cursed = () => {
  ...
  return (
    ...
    >
      <p>People are cursed with a plague.</p>
      <p>
        A plague birthed from the thick black smog of their own factories. Towns
        folk live in terror as disease lurks the streets, hiding in the shadows
        in wait for its next victim.
      </p>
      <p>
